...
| `--accept-stale-file FILE` | With `--deliberate` | Supply explicit, one-run authority for an otherwise stale context packet. It never silently refreshes or rewrites the durable source |
