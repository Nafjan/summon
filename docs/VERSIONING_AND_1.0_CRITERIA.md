...
Status: **criteria defined; 1.0.0 NOT yet claimed.** Current line is 0.14.x.
...
| C4 | Defect discovery flattened | **NOT MET** | 17 releases today; 12+ review rounds; **one** returned clean. The most recent live test -- an hour before this was written -- found the gate's definition-hash evidence was structurally always null. |
